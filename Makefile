...
setup-git:
	git remote rm origin && git remote add origin git@github-arrancar-technology.com:arrancar-technology/macross.git && git fetch && git checkout develop
	cd presentation && git remote rm origin && git remote add origin git@github-arrancar-technology.com:arrancar-technology/macross-presentation.git && git fetch && git checkout develop
	cd presentation-functional && git remote rm origin && git remote add origin git@github-arrancar-technology.com:arrancar-technology/macross-presentation-functional.git && git fetch && git checkout develop
	cd presentation-stubulator && git remote rm origin && git remote add origin git@github-arrancar-technology.com:arrancar-technology/macross-presentation-stubulator.git && git fetch && git checkout develop
